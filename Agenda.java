...
public class Agenda {
    ...
    public void cadastrarContato(Contato novoContato, List<Telefone> tels, List<Endereco> ends) throws ContatoException {
        if (contatos.contains(novoContato)) {
            throw new ContatoException("Erro: contato ja cadastrado na agenda.");
        }
    ...
    public void excluirTelefone(String cpf, String numero) {
        ...
        if (alvo == null) {
         throw new ContatoException("Contato nao encontrado com CPF: " + cpf);
        }
