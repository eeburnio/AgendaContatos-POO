...
public class Contato {
    ...
    public Contato(String cpf, String nome, String sobrenome, String email, String dataNascimento) throws DadoInvalidoException {
        if (!cpf.matches("\\d{3}\\.\\d{3}\\.\\d{3}-\\d{2}")) {
            throw new DadoInvalidoException("CPF invalido! Use o formato: ddd.ddd.ddd-dd");
        }
        this.cpf = cpf;
        this.nome = nome;
